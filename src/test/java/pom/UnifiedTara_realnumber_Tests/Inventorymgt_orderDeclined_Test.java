...
//			addpay.navigatetomerchantiflareadyuser();
			...
			WebElement productstirng=aDriver.findElementByXPath("//android.view.View[contains(@content-desc,'ProdOrderdeclined')]");
...
//			System.out.println("executed");
         ...
         //   addprod.NavigationTo_addProduct();
			Thread.sleep(6000);
			addprod.SearchProduct("ProdOrderdeclined");
            WebElement productstirng1=aDriver.findElementByXPath("//android.view.View[contains(@content-desc,'ProdOrderdeclined')]");
