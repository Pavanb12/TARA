...
//        action.longPress(x, y).moveTo(x, y-(y)).release().perform();
	...
	public void DeleteProduct() throws InterruptedException {
		...
		else { reportFail("Product delete failed");
...
{
    System.out.println("Searching  product in Inventory screen. ");
...
public void AddProductfororderoutofstock(String productname, String price, String quantity) throws InterruptedException {
   ...
   aDriver.hideKeyboard();
    ...
    public void AddProductforexceedlimit(String productname, String price, String disprice, String quantity) throws InterruptedException {
